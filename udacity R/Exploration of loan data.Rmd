...
dt <- tidyr::separate(dt,LoanOriginationDate, 
                      c("LoanOriginationYear","LoanOriginationMonth"),
                      sep="-",extra="drop")
ggplot(data=dt,aes(x=LoanOriginationYear)) + 
  geom_histogram() + 
  ggtitle("Loan origination volume has increased over time, with a drop in 2009")
```
...
p1 <- ggplot(data=dt,aes(x=ProsperScore)) + 
  geom_histogram() + 
  ggtitle("Prosper score distribution is fairly gaussian")

p2 <- ggplot(data=dt,aes(x=ProsperRating..numeric.)) + 
  geom_histogram() + 
...
ggplot(data=dt,aes(x=ListingCategory..numeric.)) + 
  ...
  ggtitle("Most common listing category is Debt consolidation; also Home Improvement and Business")
...
p1 <- ggplot(data=dt,aes(x=CreditScoreRangeLower)) + 
...
p2 <- ggplot(data=dt,aes(x=CreditScoreRangeUpper)) + 
  geom_histogram(binwidth=10) + 
  ...
  ggtitle("credti score (upper) distribution is gaussian too")
...
ggplot(data=dt,aes(x=DebtToIncomeRatio)) + 
...
dt$IncomeRange <- factor(dt$IncomeRange,
                         c("Not displayed","Not employed",
                          ...
                          "$100,000+"))
ggplot(data=dt,aes(IncomeRange)) + 
  geom_bar() + 
...
ggplot(dt,aes(EmploymentStatus)) + 
  geom_bar() +
  coord_flip() + 
...
p1 <- ggplot(subset(dt,dt$AmountDelinquent>0 & dt$AmountDelinquent < 500),
...
p2 <- ggplot(subset(dt,dt$DelinquenciesLast7Years >0),aes(DelinquenciesLast7Years)) + geom_histogram(binwidth=1) + 
  coord_trans(limx = c(0,50), limy=c(0,5000)) + 
  scale_x_continuous(breaks=seq(0,50,5)) + 
  scale_y_continuous(breaks=seq(0,5000,500)) + 
  ggtitle("Most who had previous delinquencies had less than 5 previous delinqencies")
...
ggplot(dt,aes(LoanOriginalAmount)) + geom_histogram(binwidth=1000) + 
  scale_x_continuous(breaks=c(seq(0,10000,2000),15000,20000,25000),
                     limits=c(1000,26000)) + 
...
p1 <- ggplot(dtd,aes(x=LP_CustomerPrincipalPayments_pc)) + 
...
p2 <- ggplot(dtd,aes(x=LP_InterestandFees_pc)) + 
  geom_histogram(binwidth=0.01) + 
  scale_x_continuous(breaks=seq(0,1.1,.1), lim=c(0,1.1)) + 
...
```{r}
p1 <- ggplot(dtd, aes(x = LP_NetPrincipalLoss_pc)) + 
  geom_histogram(binwidth=0.1) + 
  scale_x_continuous(breaks=seq(0,1,.1)) +
  ggtitle("Net losses")

p2 <- ggplot( subset(dtd,dtd$LP_NetPrincipalLoss_pc>0),
...
ggplot(dtc,aes(y=LP_NonPrincipalRecoverypayments_pc,x=factor(ProsperRating..numeric.))) + 
  geom_boxplot() + coord_cartesian(ylim = c(0,0.01)) + 
...
dtd <- transform(dtd, StatedMonthlyIncomeRange = cut(dtd$StatedMonthlyIncome, breaks=quantile(dtd$StatedMonthlyIncome,seq(0,1,.1)),include.lowest = TRUE, ordered_result = T ))
...
ggplot(dtd,aes(x=StatedMonthlyIncomeRange,y=LoanOriginalAmount)) + 
  geom_boxplot() + 
  scale_y_continuous(breaks=seq(0,max(dtc$LoanOriginalAmount),2000)) +
  coord_flip() + 
...
ggplot(dtd,aes(x=LoanOriginalAmount_per_Term_pc_IncomeRange,y=LP_CustomerPayments_pc)) + 
  geom_boxplot() + 
  coord_flip() + 
...
p1 <- ggplot(dtd,aes(BorrowerState)) + 
  geom_histogram() + 
  scale_y_continuous(breaks=seq(0,8000,500)) + 
  coord_flip() + 
  ggtitle("New York had 2,500 completed/defaulted loans")

p2 <- ggplot(dtd,aes(x=BorrowerState,y=LP_CustomerPayments_pc)) + 
  geom_boxplot() + 
  coord_flip() + 
  ggtitle("New York had better payment outcomes than other large states")
...
p1 <- ggplot(dtc,aes(y=CreditScoreRangeLower,x=ProsperRating..numeric.)) + 
  geom_point(alpha=0.5, stat='summary',fun.y=median) + 
  ggtitle("Lower credit scores have lower Prosper ratings")

p2 <- ggplot(dt,aes(y=CreditScoreRangeLower,x=factor(ProsperRating..numeric.))) + 
  geom_boxplot() + 
...
ggplot(dtc,aes(x=StatedMonthlyIncome,y=LP_CustomerPayments_pc,color=factor(ProsperRating..numeric.))) +
  geom_line(stat='summary',fun.y=median) + 
  scale_color_brewer(type="div",palette="Spectral") + 
  coord_cartesian(xlim = c(0,quantile(dtc$StatedMonthlyIncome,probs = .99))) +
  ggtitle("Lower rated borrowers have both higher and lower payments compared with higher rated borrowers")

ggplot(dtc,aes(x=StatedMonthlyIncomeRange,y=LP_CustomerPayments_pc,color=factor(ProsperRating..numeric.))) +
  geom_boxplot() +
  scale_color_brewer(type="div",palette="Spectral") + 
  coord_flip() +
  ggtitle("A higher rating is related to less varied payments at any income level")

ggplot(dtc,aes(x=StatedMonthlyIncomeRangeNumeric,y=LP_CustomerPayments_pc,
               color=factor(dtc$ProsperRating..numeric.))) + 
  geom_line(stat='summary',fun.y=median) + 
  scale_color_brewer(type="seq",palette="RdYlBu") + 
  coord_cartesian(xlim = c(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,probs = .99))) + 
  scale_x_continuous(breaks=seq(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,.99),1000)) +
  ggtitle("Median payments of lower rated borrowers are higher than for higher rated ones")
...
#try credit rating and payments
#since the distribution is concentrated and uneven, I'll split them into 10 quantiles
#ggplot(dtd,aes(x=CreditScoreRangeLower)) + geom_histogram()


#remove NA's for credit ratings; also remove zeros; most credit score ranges have a minimum of 280 or 300
dtr <- subset(dtd,!is.na(CreditScoreRangeLower) & !is.na(CreditScoreRangeUpper) & CreditScoreRangeLower!="" & CreditScoreRangeUpper != "" & CreditScoreRangeLower!=0 & CreditScoreRangeUpper != 0)
#count(dtr)

#table(dtr$CreditScoreRangeLower)
#table(dtr$CreditScoreRangeUpper)
dtr <- transform(dtr, CreditScoreRangeLowerQuantile = 
                   cut(dtr$CreditScoreRangeLower,breaks = 
                         quantile(dtr$CreditScoreRangeLower,probs=seq(0,1,.1)),include.lowest = T))
#check that new column has no NA's, and zeros are removed
#summary(dtr$CreditScoreRangeLowerQuantile)

dtr <- transform(dtr, StatedMonthlyIncomeRangeNumeric = floor(StatedMonthlyIncome / 500)*500)

ggplot(dtr,aes(x=StatedMonthlyIncomeRange,y=LP_CustomerPayments_pc,
               color=CreditScoreRangeLowerQuantile)) + 
  geom_boxplot() + 
  scale_color_brewer(type="seq",palette="RdYlBu") + 
  coord_flip() + 
  ggtitle("At the 560 to 680 range, median payments exceed those with higher and lower ratings")


ggplot(dtr,aes(x=StatedMonthlyIncomeRangeNumeric,y=LP_CustomerPayments_pc,
               color=CreditScoreRangeLowerQuantile)) + 
  geom_line(stat='summary',fun.y=median) + 
  scale_color_brewer(type="seq",palette="RdYlBu") + 
  coord_cartesian(xlim = c(0,quantile(dtr$StatedMonthlyIncomeRangeNumeric,probs = .99))) + 
  scale_x_continuous(breaks=seq(0,quantile(dtr$StatedMonthlyIncomeRangeNumeric,.99),1000)) +
  ggtitle("For credit scores of 740 and above, payments are at least 100% of the loan at any income")
...
p_median <- ggplot(dtc,aes(x=StatedMonthlyIncomeRangeNumeric,y=LP_CustomerPayments_pc,
                           color=factor(dtc$ProsperRating..numeric.))) + 
  geom_line(stat='summary',fun.y=median) + 
  scale_color_brewer(type="seq",palette="RdYlBu") + 
  coord_cartesian(xlim = c(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,probs = .99))) + 
  scale_x_continuous(breaks=seq(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,.99),1000)) + 
  ggtitle("Median Customer Payments as % of loan")

p_25 <- ggplot(dtc,aes(x=StatedMonthlyIncomeRangeNumeric,y=LP_CustomerPayments_pc,
                       color=factor(dtc$ProsperRating..numeric.))) + 
  geom_line(stat='summary',fun.y=quantile,probs=.25) + 
  scale_color_brewer(type="seq",palette="RdYlBu") + 
  coord_cartesian(xlim = c(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,probs = .99))) + 
  scale_x_continuous(breaks=seq(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,.99),1000)) + 
  ggtitle("25% quantile of Customer Payments as % of loan")

p_75 <- ggplot(dtc,aes(x=StatedMonthlyIncomeRangeNumeric,y=LP_CustomerPayments_pc,
                       color=factor(dtc$ProsperRating..numeric.))) + 
  geom_line(stat='summary',fun.y=quantile,probs=.75) + 
  scale_color_brewer(type="seq",palette="RdYlBu") + 
  coord_cartesian(xlim = c(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,probs = .99))) + 
  scale_x_continuous(breaks=seq(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,.99),1000)) + 
  ggtitle("75% quantile of Customer Payments as % of loan")
...
p_median <- ggplot(dtc,aes(x=StatedMonthlyIncomeRangeNumeric,y=LP_InterestandFees_pc,
  ...
  coord_cartesian(xlim = c(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,probs = .99))) + 
  scale_x_continuous(breaks=seq(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,.99),1000)) + 
  ggtitle("Median Interest and Fees as % of loan")
...
p_25 <- ggplot(dtc,aes(x=StatedMonthlyIncomeRangeNumeric,y=LP_InterestandFees_pc,
  ...
  coord_cartesian(xlim = c(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,probs = .99))) + 
  scale_x_continuous(breaks=seq(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,.99),1000)) + 
  ggtitle("25% quantile of Interest and Fees as % of loan")
...
p_75 <- ggplot(dtc,aes(x=StatedMonthlyIncomeRangeNumeric,y=LP_InterestandFees_pc,
  ...
  coord_cartesian(xlim = c(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,probs = .99))) + 
  scale_x_continuous(breaks=seq(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,.99),1000)) + 
  ggtitle("75% quantile of Interest and Fees as % of loan")
...
p_median <- ggplot(dtc,aes(x=StatedMonthlyIncomeRangeNumeric,y=LP_CustomerPrincipalPayments_pc,
                           color=factor(dtc$ProsperRating..numeric.))) +
  geom_line(stat='summary',fun.y=median) + scale_color_brewer(type="seq",palette="RdYlBu") + 
  coord_cartesian(xlim = c(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,probs = .99))) + 
  scale_x_continuous(breaks=seq(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,.99),1000)) + 
  ggtitle("Median Principal Payments as % of loan")

p_25 <- ggplot(dtc,aes(x=StatedMonthlyIncomeRangeNumeric,y=LP_CustomerPrincipalPayments_pc,
                       color=factor(dtc$ProsperRating..numeric.))) + 
  geom_line(stat='summary',fun.y=quantile,probs=.25) + 
  scale_color_brewer(type="seq",palette="RdYlBu") + 
  coord_cartesian(xlim = c(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,probs = .99))) + 
  scale_x_continuous(breaks=seq(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,.99),1000)) + 
  ggtitle("25% quantile of Principal Payments as % of loan")

p_75 <- ggplot(dtc,aes(x=StatedMonthlyIncomeRangeNumeric,y=LP_CustomerPrincipalPayments_pc,
                       color=factor(dtc$ProsperRating..numeric.))) + 
  geom_line(stat='summary',fun.y=quantile,probs=.75) + 
  scale_color_brewer(type="seq",palette="RdYlBu") + 
  coord_cartesian(xlim = c(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,probs = .99))) +
  scale_x_continuous(breaks=seq(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,.99),1000)) + 
  ggtitle("75% quantile of Principal Payments as % of loan")
...
#   12    36    60 
# 1531 20778  3696 
p_obs <- ggplot(dtc,aes(x=StatedMonthlyIncomeRangeNumeric)) + 
  geom_histogram(binwidth = 500) + 
  coord_cartesian(xlim = c(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,probs = .99))) + 
  scale_x_continuous(breaks=seq(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,.99),5000)) + 
  facet_wrap(~Term) + 
  ggtitle("Number of observations by income") + 
  scale_color_brewer(type = 'div', 
                     guide = guide_legend(title = 'Count', reverse = F,
...
p_median <- ggplot(dtc,aes(x=StatedMonthlyIncomeRangeNumeric,y=LP_CustomerPayments_pc,
  ...
  scale_x_continuous(breaks=seq(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,.99),5000)) + 
  facet_wrap(~Term) + 
  ggtitle("Median Customer Payments as % of loan, facet by term (12,36,60)")
...
p_25 <- ggplot(dtc,aes(x=StatedMonthlyIncomeRangeNumeric,y=LP_CustomerPayments_pc,
  ...
  scale_x_continuous(breaks=seq(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,.99),5000)) + 
  facet_wrap(~Term) + 
  ggtitle("25% quantile of Customer Payments as % of loan, facet by term (12,36,60)")
...
p_75 <- ggplot(dtc,aes(x=StatedMonthlyIncomeRangeNumeric,y=LP_CustomerPayments_pc,
  ...
  scale_x_continuous(breaks=seq(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,.99),5000)) + 
  facet_wrap(~Term) + 
  ggtitle("75% quantile of Customer Payments as % of loan, facet by term (12,36,60)")
...
```{r}
#table(dt$LoanStatus)
qplot(dt$LoanStatus) + coord_flip()

#table(dt$LoanFirstDefaultedCycleNumber)
p1 <- qplot(dt$LoanFirstDefaultedCycleNumber,binwidth=1)

#table(dt$LoanCurrentDaysDelinquent)
p2 <- ggplot(subset(dt,dt$LoanCurrentDaysDelinquent >0),
             aes(x=LoanCurrentDaysDelinquent)) + 
  geom_histogram() + 
  ggtitle("Loan that are delinquent")

p3 <- ggplot(dt,aes(x=LoanMonthsSinceOrigination)) + 
  geom_histogram() + 
  ggtitle("All loans")

p4 <- ggplot(subset(dt,dt$LoanCurrentDaysDelinquent >0),
...
p1 <- ggplot(dtc,aes(x=LoanFirstDefaultedCycleNumber)) + 
  geom_histogram(binwidth=1) + 
  ggtitle("Number of borrowers for each month of first default")

p2 <- ggplot(dtc,aes(x=LoanFirstDefaultedCycleNumber, y=LP_CustomerPayments_pc, 
                     color=factor(dtc$ProsperRating..numeric.))) +
  geom_line(stat='summary', fun.y=median) + 
  scale_color_brewer(type = 'seq', palette='RdYlBu',
                     guide = guide_legend(title='Rating', reverse = T, 
...
```{r}
p1 <- ggplot(dtc,aes(x=StatedMonthlyIncomeRangeNumeric,y=LoanFirstDefaultedCycleNumber, 
               color=factor(dtc$ProsperRating..numeric.))) + 
...
p2 <- ggplot(dtc,aes(y=StatedMonthlyIncome,x=factor(LoanFirstDefaultedCycleNumber))) + 
  geom_boxplot() + 
...
```{r}
p1 <- ggplot(dtc,aes(y=DebtToIncomeRatio,x=LoanFirstDefaultedCycleNumber, 
               color=factor(dtc$ProsperRating..numeric.))) + 
...
p2 <- ggplot (dtc,aes(x=factor(LoanFirstDefaultedCycleNumber),y=DebtToIncomeRatio)) + 
  geom_boxplot() + 
  coord_cartesian(ylim=c(0,1)) + 
...
```{r}
p1 <- ggplot(dtc,aes(x=LoanOriginalAmount,y=LoanFirstDefaultedCycleNumber, 
               color=factor(dtc$ProsperRating..numeric.))) + 
  geom_point(stat='summary',fun.y=mean) + 
  coord_cartesian(xlim = c(0,quantile(dtc$LoanOriginalAmount, probs=.90,,na.rm=T))) + 
  scale_color_brewer(type = 'seq', palette='RdYlBu',
                     guide = guide_legend(title='Rating', reverse = T, 
                                          override.aes = list(alpha=1,size=2))) + 
  coord_flip() + 
...
p2 <- ggplot(dtc,aes(x=factor(LoanFirstDefaultedCycleNumber),y=LoanOriginalAmount)) + 
  geom_boxplot() + 
...
p1 <- ggplot(dtc,aes(y=LoanOriginalAmount_per_Term_pc_IncomeRange,
                     x=LoanFirstDefaultedCycleNumber, 
                     color=factor(dtc$ProsperRating..numeric.))) + 
  geom_line(alpha=0.5, stat='summary',fun.y=median) + 
  coord_cartesian(ylim = c(0,10)) + 
  scale_color_brewer(type = 'seq', palette='RdYlBu',
                     guide = guide_legend(title='Rating', reverse = T,
                                          override.aes = list(alpha=1,size=2)))

p2 <- ggplot(dtc,aes(x=factor(LoanFirstDefaultedCycleNumber),
...
p1 <- ggplot(dtc,aes(x=MonthlyLoanPayment,y=LoanFirstDefaultedCycleNumber)) + 
  geom_point(alpha=0.5, stat='summary',fun.y=median) + 
...
```{r}
ggplot(dt,aes(y=CreditScoreRangeLower,
...
ggplot(dtr,aes(x=StatedMonthlyIncomeRange,y=LP_CustomerPayments_pc,
  ...
  geom_boxplot() + 
  scale_color_brewer(type="seq",palette="RdYlBu",
                     guide = guide_legend(title = 'Credit Score', 
                                          reverse = T,
                                          override.aes = list(alpha = 1, size = 2))) + 
...
p_obs <- 
  ggplot(dtc,aes(x=StatedMonthlyIncomeRangeNumeric)) + 
  geom_histogram(binwidth = 500) + 
  coord_cartesian(xlim = c(0,quantile(dtc$StatedMonthlyIncomeRangeNumeric,probs = .99))) + 
  scale_x_continuous(breaks=c(seq(0,8000,2000),
                              seq(10000,quantile(dtc$StatedMonthlyIncomeRangeNumeric,.99),5000)) ) + 
  facet_wrap(~Term) + ggtitle("Number of observations by income") + 
  scale_color_brewer(type = 'div', 
                     guide = guide_legend(title = 'Count', reverse = F,
                                          override.aes = list(alpha = 1, size = 2)))

p_median <- ggplot(dtc,aes(x=StatedMonthlyIncomeRangeNumeric,
  ...
  scale_x_continuous(breaks=
                       c(seq(0,8000,2000),
                         seq(10000,quantile(dtc$StatedMonthlyIncomeRangeNumeric,.99),5000))) + 
  facet_wrap(~Term) + ggtitle("Median Customer Payments as % of loan, facet by term (12,36,60)")

p_25 <- ggplot(dtc,aes(x=StatedMonthlyIncomeRangeNumeric,
                       y=LP_CustomerPayments_pc,
                       color=factor(dtc$ProsperRating..numeric.))) + 
  geom_line(stat='summary',fun.y=quantile,probs=.25) + 
  scale_color_brewer(type="seq",palette="RdYlBu", 
...
p_75 <- ggplot(dtc,aes(x=StatedMonthlyIncomeRangeNumeric,
                       y=LP_CustomerPayments_pc,
                       color=factor(dtc$ProsperRating..numeric.))) + 
  geom_line(stat='summary',fun.y=quantile,probs=.75) + 
  scale_color_brewer(type="seq",palette="RdYlBu", 
...
p2 <- ggplot(dtc,aes(x=LoanFirstDefaultedCycleNumber, 
                     y=LP_CustomerPayments_pc, 
                     color=factor(dtc$ProsperRating..numeric.))) + 
  geom_line(stat='summary', fun.y=median) + 
  scale_color_brewer(type = 'seq', palette='RdYlBu',
